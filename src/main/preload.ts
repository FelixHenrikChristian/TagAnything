...
const electronHandler = {
  ...
  generateImageThumbnail: (imagePath: string) => ipcRenderer.invoke('generate-image-thumbnail', imagePath),
  isImageFile: (filePath: string) => ipcRenderer.invoke('is-image-file', filePath),
